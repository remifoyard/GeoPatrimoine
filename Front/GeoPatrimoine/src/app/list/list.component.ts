  ...
  donneesChargees(data) {
       ...
       let obj = data;
        ...
        for (const i of obj) {
          ...
          for (const obj2 in i) {
            if (obj2 === 'geoTag') {
              const longitude: any = i[obj2].split(',')[1];
              const latitude: any = i[obj2].split(',')[0];
              const nom: any = i['nom'];
              const id: any = i['id'];
              const description: any = i['description'];
              const lienImage: any = i['lienImage'];
              const horaires: any = i['horaires'];
              const adresse: any = i['adresse'];
              const codePostal: any = i['codePostal'];
              const commune: any = i['commune'];
              const telephone: any = i['telephone'];
              const tarif: any = i['tarif'];
              const lienAudio: any = i['lienAudio'];
